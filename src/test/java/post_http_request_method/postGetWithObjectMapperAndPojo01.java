...
public class postGetWithObjectMapperAndPojo01 extends HerOkuAppBaseUrl {
    ...
    public void postGetWithObjectMapperAndPojo01 (){
                            //TO SENDE POST REQUEST WE DID 1.Step, 2. Step, 3.Step
        //1.Step : Set The URL
        ...
        System.out.println(postResponseBodyInPojo);
            ...
            //FROM postResponseBodyInPojo WE GOT THE VALUE OF bookinId bu using GETTER of bookinId
        Integer bookinId = postResponseBodyInPojo.getBookingid();
